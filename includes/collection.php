...
?>
    ...
    <div class="container">
        ...
        <a href="#collectionDetails" data-toggle="collapse" class="btn btn-default">
        ...
        <div>
            ...
            <div id="collectionDetails" class="collapse">
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        <td>&#x20B1;
                            <?php
                                $sql_gross = "SELECT sum( DISTINCT transactions.amount) 'gross_sales' FROM transactions join orders on transactions.transactid = orders.transactid WHERE orders.collectionid='$collection_id' and transactions.status='paid'";
                        ...
                        <td><b>&#x20B1;
                            <?php 
                                if (($sales - $collection_capital) < 0){
                                    echo "0";
                                }else{
                                    echo number_format($sales-$collection_capital);
                                }
                            ?>
                            </b>
                        </td>
            ...
            <table id="collectionItemTable" class="table table-bordered dt-responsive nowrap" width="100%">
                <thead>
                    <th>Item</th>
                    <th>Price</th>
                    <th>Status</th>
                    ...
                    if (mysqli_num_rows($result_items) > 0){
                        while($row_items = mysqli_fetch_assoc($result_items)){
                            ...
                            <tr class="bg-success">
                                ...
                                <td>$itemPrice</td>
                                <td>$itemStatus</td>
                                <td><a href="includes/removeItem.inc.php?itemid=$itemid&collection=$collectionName" class="btn btn-default"><span class="glyphicon glyphicon-trash" aria-hidden="true" style="color: #e74c3c;"></span>
                                </a>
                                <a href="edititem.php?itemid=$itemid&itemname=$itemName&collectionid=$collection_id&collection=$collectionName" class="btn btn-default"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a></td>
