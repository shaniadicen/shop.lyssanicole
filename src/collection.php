...
<div class="container">
  <h3>
    ...
    <a href="#" class="btn btn-default" data-toggle="modal" data-target="#addCollectionItem">
              ...
              if (mysqli_num_rows($result_items) > 0){
                while($row_items = mysqli_fetch_assoc($result_items)){
                  ...
                  <tr style="background-color: #FFC0CB;">
                      ...
                      <td>$itemStatus</td>
                      <td>
                      <a href="edititem.php?itemid=$itemid&itemname=$itemName&collectionid=$collection_id&collection=$collectionName" class="btn btn-default">
