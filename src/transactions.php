...
?>
    ...
    <div class="container">
        <h2 class="pagehead">Transactions <span style="font-size: 20px;color: #FFC0CB" class=" glyphicon glyphicon-transfer "></span> </h2>
        <a href="#" class="btn btn-default" data-toggle="modal" data-target="#addTransaction"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add Transaction</a>
